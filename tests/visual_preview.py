...
class Preview(FixtureHandler):
    def do_GET(self):
        ...
        if path == '/app.js':
            ...
            self.send(200, (server.ROOT / 'public/app.js').read_bytes() + mobile, 'text/javascript; charset=utf-8')
            return
        data = None
